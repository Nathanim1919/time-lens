                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        <div className="mb-6">
                            ...
                            <p className="text-gray-400 leading-relaxed max-w-md">
                                Transform your photos across different eras, cultures, and styles with our advanced AI technology. 
                                Discover new versions of yourself through time.
                            </p>
                        </div>
                        
                        {/* Social Links */}
                        <div className="flex space-x-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-all duration-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li>
                                <Link href="/upload" className="text-gray-400 hover:text-white transition-colors duration-300">
                                    Upload Photo
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="/test-transform" className="text-gray-400 hover:text-white transition-colors duration-300">
                                    Test Transform
                                </Link>
                            </li>
                            <li>
                                <Link href="/in" className="text-gray-400 hover:text-white transition-colors duration-300">
                                    Dashboard
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="border-t border-white/10 pt-12 mb-12">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <p className="text-gray-400 mb-8">
                            Get the latest updates on new features, styles, and AI improvements.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                            <input
                                type="email"
                                placeholder="Enter your email"
                                className="flex-1 px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 transition-colors duration-300"
                            />
                ...
                <div className="border-t border-white/10 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="text-gray-400 text-sm mb-4 md:mb-0">
                            © 2024 TimeLens. All rights reserved.
                        </div>
